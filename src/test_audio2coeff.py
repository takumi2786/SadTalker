...
class Audio2Coeff():
    ...
    def load_Audio2Exp(self, device, sadtalker_path, cfg_exp):
        ...
        audio2exp_model = Audio2Exp(netG, cfg_exp, device=device, prepare_training_loss=False)
...
class Audio2CoeffV2(Audio2Coeff):
    ...
    def load_Audio2Exp(self, device, sadtalker_path, cfg_exp):
        ...
        try:
            ...
            raise Exception("Failed in loading audio2exp_checkpoint")
        audio2exp_model = Audio2ExpV2(netG, cfg_exp, device=device, prepare_training_loss=False)
        return audio2exp_model
